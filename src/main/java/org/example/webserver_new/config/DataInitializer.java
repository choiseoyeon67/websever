...
public class DataInitializer {
    ...
    public CommandLineRunner seedData() {
        return args -> {
            ...
            DevProfile developerProfile = devProfileRepository.findByUser_Id(developer.getId())
                    .orElseGet(() -> {
                        DevProfile profile = new DevProfile();
                        profile.setUser(developer);
            ...
            List<Project> projects = List.of(
                    createProject(client, "AI 기반 쇼핑몰 플랫폼 개발", "도급외주", 800, 45, "개발", "OPEN", "서울", List.of("React", "Spring", "MySQL"), 3),
                    createProject(client, "React 관리자 페이지 리뉴얼", "상주", 700, 60, "개발", "OPEN", "경기", List.of("React", "TypeScript"), 8),
                    createProject(client, "숙박 예약 서비스 앱 개발", "도급외주", 1500, 90, "개발", "OPEN", "부산", List.of("React Native", "Spring"), -1),
                    createProject(client, "B2B 견적 관리 시스템", "도급외주", 1200, 70, "개발", "OPEN", "서울", List.of("Vue", "Spring", "JPA"), 12),
                    createProject(client, "물류 대시보드 고도화", "상주", 650, 80, "개발", "OPEN", "인천", List.of("React", "Chart.js"), 15),
                    createProject(secondClient, "병원 예약 웹서비스 구축", "도급외주", 1800, 100, "개발", "OPEN", "대전", List.of("Spring", "MySQL"), 20),
                    createProject(secondClient, "교육 플랫폼 유지보수", "상주", 550, 120, "개발", "OPEN", "대구", List.of("Java", "Spring"), 25),
                    createProject(secondClient, "커뮤니티 서비스 MVP", "도급외주", 900, 50, "개발", "OPEN", "광주", List.of("React", "Node.js"), 30),
                    createProject(secondClient, "결제 모듈 연동 프로젝트", "도급외주", 700, 35, "개발", "OPEN", "서울", List.of("Spring", "Payment"), 40),
                    createProject(secondClient, "사내 업무 포털 개편", "상주", 600, 90, "개발", "CLOSED", "서울", List.of("React", "Java"), -5)
            );
            projectRepository.saveAll(projects);

            createApplication(projects.get(0), developerProfile, 30, 750, null, null, 1, null, "프로젝트 구조를 빠르게 파악하고 일정 내 구현하겠습니다.");
            createApplication(projects.get(1), developerProfile, null, null, "프론트엔드", "중급", 1, 650, "운영 중인 관리자 페이지 개선 경험이 있습니다.");
            createApplication(projects.get(3), developerProfile, 50, 1100, null, null, 1, null, "견적과 승인 흐름이 있는 B2B 시스템 경험이 있습니다.");
        };
    }
